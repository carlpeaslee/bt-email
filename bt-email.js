        ...
        <mj-container>
          <mj-section>
            <mj-column>
              ...
              <mj-image width="100" src="https://test.bouncetribe.com/logo.png"></mj-image>

              <mj-divider border-color="#9575cd"></mj-divider>

              <mj-text font-size="20px" color="#555555" font-family="helvetica">Hello! You received a friend request from ${handle}.</mj-text>
...
const test = (ctx, done) => {
  ...
  let {actor, recipient} = ctx.body.createdNode
